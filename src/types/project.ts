...
export interface TaskRecord {
  ...
  start_date: string;
  end_date: string;
  supervisor_workers: number;
  foreman_workers: number;
  carpenter_workers: number;
  mason_workers: number;
  steelman_workers: number;
  welder_workers: number;
  painter_workers: number;
  operator_workers: number;
  ...
  time_hours: number;
  daily_output: number;
  daily_labor_output: number;
  weekly_output: number;
  weekly_labor_output: number;
  monthly_output_by_weeks: number;
  monthly_labor_output_by_weeks: number;
  monthly_output_by_days: number;
  monthly_labor_output_by_days: number;
